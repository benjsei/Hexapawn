...
namespace HexapawnBDD.BDD.Jeu.Regles.ConditionsVictoire
{
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Thomas gagne par destruction")]
        [NUnit.Framework.CategoryAttribute("ConditionsVictoireTest")]
        public virtual void ThomasGagneParDestruction()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Thomas gagne par destruction", null, new string[] {
                        "ConditionsVictoireTest"});
#line 25
this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
