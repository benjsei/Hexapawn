...
#Rule: Règle 1 - Le deplacement d'un pion est visible sur le plateau.
@DeplacementTest
...
#Rule: Règle 2 - Le deplacement d'une case vide n'est pas pris en compte.
@DeplacementTest
...
#Rule: Règle 3 - Le deplacement d'un pion sur un pion adverse est une prise.
@DeplacementTest
...
#Rule: Règle 4 - Le deplacement d'un pion sur un pion du même joueur n'est pas pris en compte.
@DeplacementTest
